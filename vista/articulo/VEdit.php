...
<br>
<form action="?control=CArticulo&accion=update&id=<?php echo $articulo->id ?>" method="post" class="formControl">
    <!-- DATOS -->
    <div class="row">
        <div class="col col-lg-5 col-sm-10">
            ...
            <input type="number" id="tbCantidad" name="tbCantidad" placeholder="Cantidad..." value="<?php echo $articulo->cantidad ?>" required class="textBoxControl w-lg-10"><br>
        </div>
    </div>
    <br>
    <!-- BOTON -->
